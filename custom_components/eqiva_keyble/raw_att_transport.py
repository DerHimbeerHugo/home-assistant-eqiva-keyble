...
class RawAttTransport(EqivaTransport):
    ...
    async def session_ready(self) -> None:
        ...
        if (
            ...
            # v29 deliberately made this a no-op. The older explicit SMP and
            # protected CCCD experiments remain in the historical patch files.
    ...
    async def write(self, data: bytes) -> None:
        ...
        try:
            # EqivaRawATTClient implements v37 here: response=True still emits
            # opcode 0x12, but no ATT transaction future is awaited.
